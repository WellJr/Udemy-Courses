package com.udemy.faturacartaocredito.reader;

import com.udemy.faturacartaocredito.dominio.CartaoCredito;
import com.udemy.faturacartaocredito.dominio.Cliente;
...
public class LerTransacoesReaderConfig {
    ...
    public JdbcCursorItemReader<Transacao> lerTransacoesReader(
        ...
        return new JdbcCursorItemReaderBuilder<Transacao>()
                ...
                .rowMapper(rowMapperTransacao()) // <-- usado normalment quando precisa mapear tipos compostos
                .build();
    }
